...
################################################################################
@click.command()
@click.argument('dataset_name', type=click.Choice(['mnist', 'cifar10','casting']))
@click.argument('net_name', type=click.Choice(['mnist_LeNet', 'cifar10_LeNet', 'cifar10_LeNet_ELU','casting_LeNet']))
...
def main(dataset_name, net_name, xp_path, data_path, load_config, load_model, objective, nu, device, seed,
    ...
    if dataset_name in ('mnist', 'cifar10','casting'):
        ...
        if dataset_name == 'casting':
            X_normals = torch.tensor(dataset.test_set.test_data[idx_sorted[:32], ...] )
            X_outliers = torch.tensor(dataset.test_set.test_data[idx_sorted[-32:], ...])
        #print(dataset.test_set.test_data.shape)
